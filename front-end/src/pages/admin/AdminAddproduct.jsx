...
const {mutate,isLoading:DeleteIsloading}=UseAdminDelete()
    ...
    <div className="bg-stone-200  p-5">
        <div className="bg-white flex flex-col gap-5 min-h-[85vh] h-auto p-5 rounded-lg">
            <div className="flex flex-row justify-between">
              ...
              <NavLink to='/adminform'><button className="bg-blue-600 rounded-lg hover:bg-blue-500 transition-all text-white font-semibold p-3">Add products</button></NavLink>
            </div>
            <div className="flex flex-row justify-between">
            ...
            <div className=" xs:overflow-scroll">
              ...
              {isLoading ?<Loading/> : <AdminAddproductShow deleting={mutate} data={data} next={next} prev={pre} btnext={setnext} btnprv={setPrev}/>}
            </div>
        </div>
    </div>
  )
